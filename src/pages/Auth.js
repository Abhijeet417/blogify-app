     ...
     if(!signUp){
        if(email && password){
          ...
          setActive("home");
           ...
           return toast.error("No such user . Please check your credentials !!");
        }
     }else{
        ...
        if(firstName && lastName && email && password){
            ...
            return toast.error("All feilds are neccassary to fill !!");
        }
     }
     navigate("/");
  };
            ...
            <div className="row h-100 justify-content-center allign-items-center">
               <div className="col-10 col-md-8 col-lg-6">
                  ...
                  <div>
                     {!signUp ? ( 
                       <>
                          <div className="text-center justify-content-center pt-2 mt-2">
